...
public class ServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> ServiceLoader<S> load(Class<S> serviceClass) {
        switch (serviceClass.getName()) {
            ...
            case "dev.webfx.framework.client.ui.uirouter.UiRoute": return new ServiceLoader<S>(mongoose.client.activities.login.LoginUiRoute::new, mongoose.client.activities.unauthorized.UnauthorizedUiRoute::new, mongoose.frontoffice.activities.startbooking.StartBookingUiRoute::new, mongoose.frontoffice.activities.options.OptionsUiRoute::new, mongoose.frontoffice.activities.person.PersonUiRoute::new, mongoose.frontoffice.activities.summary.SummaryUiRoute::new, mongoose.frontoffice.activities.terms.TermsUiRoute::new, mongoose.frontoffice.activities.fees.FeesUiRoute::new, mongoose.frontoffice.activities.program.ProgramUiRoute::new, mongoose.frontoffice.activities.cart.CartUiRoute::new, mongoose.frontoffice.activities.contactus.ContactUsUiRoute::new, mongoose.frontoffice.activities.payment.PaymentUiRoute::new);
            ...
            case "dev.webfx.platform.gwt.services.resource.spi.impl.GwtResourceBundle": return new ServiceLoader<S>(mongoose.frontoffice.application.gwt.embed.EmbedResourcesBundle.ProvidedGwtResourceBundle::new);
            ...
            case "javafx.application.Application": return new ServiceLoader<S>(mongoose.frontoffice.application.MongooseFrontOfficeApplication::new);
