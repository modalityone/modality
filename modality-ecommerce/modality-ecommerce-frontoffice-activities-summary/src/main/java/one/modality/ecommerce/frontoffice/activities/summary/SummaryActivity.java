...
final class SummaryActivity extends BookingProcessActivity {
  ...
  protected void createViewNodes() {
    ...
    FXProperties.runNowAndOnPropertiesChange(
        p -> setTermsCheckBoxText(Strings.toSafeString(p.getValue())), agreeTCTranslationProperty);
  ...
  private void showTermsDialog() {
    // new TermsDialog(getEventId(), getDataSourceModel(), getI18n(), pageContainer).setOnClose(()
    // -> termsCheckBox.setSelected(true)).show();
