...
public class ServerDelegatedPaymentProvider implements DelegatedPaymentProvider {
    ...
    protected static String STRIPE_API_KEY =
            "sk_test_51LZvA1AHcMXMUjXlSTy6TnE1bSpUkgY46eniZju5bGZ9uFXCYsVKZfVTXqET2wRTU7ZoIyLqaP7icmPDIosQzn0L005tfSqEeT";
    ...
    private static List<DelegatedPaymentGatewayProvider> getProviders() {
        return MultipleServiceProviders.getProviders(
                DelegatedPaymentGatewayProvider.class,
                () -> ServiceLoader.load(DelegatedPaymentGatewayProvider.class));
    }
    ...
    public Future<InitiateDelegatedPaymentResult> initiateDelegatedPayment(
        ...
        if (providers.isEmpty()) return Future.failedFuture("No delegated payment gateway found!");
        return providers
                .get(0) // Temporary
                .initiateDelegatedPayment(
                        new InitiateDelegatedPaymentGatewayArgument(
                                argument, STRIPE_API_KEY, PAYMENT_SUCCESS_URL, PAYMENT_CANCEL_URL));
    }
}
