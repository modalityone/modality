...
public class DirectPaymentUI {
    ...
    public Node buildNode() {
        ...
        payBtn.setOnAction(e -> {
            ...
            cancelPayBtn.setDisable(true);
            DirectPaymentService.makeDirectPayment(new MakeDirectPaymentArgument((int) (100 * Double.parseDouble(amountTF.getText())), null, ccNumberTF.getText(), expiryTF.getText()))
