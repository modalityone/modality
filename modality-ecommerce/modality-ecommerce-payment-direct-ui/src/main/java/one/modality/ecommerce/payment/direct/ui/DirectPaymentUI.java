package one.modality.ecommerce.payment.direct.ui;
 ...
 * @author Bruno Salmon
 */
public class DirectPaymentUI {

    private static final int CC_NUMBER_LENGTH = 16;
    private static final int CC_EXPIRY_LENGTH = 4;
    ...
    public Node buildNode() {
        ...
        payBtn.setOnAction(
                e -> {
                    ...
                    DirectPaymentService.makeDirectPayment(
                                    new MakeDirectPaymentArgument(
                                            (int) (100 * Double.parseDouble(amountTF.getText())),
                                            null,
                                            ccNumberTF.getText(),
                                            expiryTF.getText()))
                            .onSuccess(
                                    r -> Console.log(r.isSuccess() ? "Payment OK!" : "Payment KO!"))
        ...
        grid.setBorder(
                new Border(
                        new BorderStroke(
                                Color.GRAY, BorderStrokeStyle.SOLID, null, BorderStroke.THIN)));
