...
public final class StatisticsGanttCanvas {
    ...
    private final BarDrawer attendanceDrawer =
            new BarDrawer() // unique instance to draw all the bars
                    // Setting the unchanging properties (remaining changing properties will be set
                    // in drawBar())
    ...
    private final BarDrawer grandparentItemFamilyDrawer =
            new BarDrawer() // unique instance to draw all the room types
                    // Setting the unchanging properties (remaining changing properties will be set
                    // in drawGrandParentItemFamily())
                    .setTextFill(Color.rgb(0, 150, 214))
                    .setBackgroundFill(Color.ALICEBLUE)
                    .setClipText(
                            false); // So the text is always visible even when slider is on left
