...
public final class AddNewTransferRequest
        implements HasOperationCode, HasOperationExecutor<AddNewTransferRequest, Void> {

    private static final String OPERATION_CODE = "AddNewTransfer";
