...
public final class DirectPaymentService {
    ...
    public static DirectPaymentProvider getProvider() {
        return SingleServiceProvider.getProvider(
                DirectPaymentProvider.class, () -> ServiceLoader.load(DirectPaymentProvider.class));
    }

    public static Future<MakeDirectPaymentResult> makeDirectPayment(
            MakeDirectPaymentArgument argument) {
        return getProvider().makeDirectPayment(argument);
    }

    public static Future<GetDirectPaymentGatewayInfosResult> getDirectPaymentGatewayInfos(
