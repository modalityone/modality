...
final class StatementsPresentationModel extends EventDependentGenericTablePresentationModel
    ...
    private final ObjectProperty<Entity> selectedMoneyAccountProperty =
    ...
    private final ObjectProperty<MoneyTransfer> selectedGroupProperty =
            new SimpleObjectProperty<>();
    ...
    private final ObjectProperty<MoneyTransfer> selectedMasterProperty =
            new SimpleObjectProperty<>();
