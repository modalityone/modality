package one.modality.ecommerce.payment.api.gateway.spi.impl.authorizedotnet;
 ...
 * @author Bruno Salmon
 */
public class AuthorizeDotNetApiPaymentGatewayProvider implements ApiPaymentGatewayProvider {
    ...
    private MakeApiPaymentResult makeDirectPaymentBlocking(MakeApiPaymentArgument argument) {
        ...
        return new MakeApiPaymentResult(success);
    }
}