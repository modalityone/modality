...
module modality.ecommerce.payment.custom.buscall {
  ...
  provides dev.webfx.stack.com.serial.spi.SerialCodec with
      one.modality.ecommerce.payment.custom.buscall.serial.InitiateCustomPaymentArgumentSerialCodec,
      one.modality.ecommerce.payment.custom.buscall.serial.InitiateCustomPaymentResultSerialCodec;
}
