...
final class PersonActivity extends BookingProcessActivity {
    ...
    */
    ...
    FlowPane accountTabs =
        new FlowPane(
            ...
            new Button(null, newRadioButton("IAlreadyHaveAnAccount", accountToggleGroup)));
    ...
    verticalStack
        ...
        .setAll(
            ...
            new VBox(LayoutUtil.setUnmanagedWhenInvisible(accountTabs, notLoggedIn), accountPane));
    syncUiFromModel();
  }
  ...
  public void onPause() {
    super.onPause();
    syncModelFromUi();
    // Clearing the computed price cache on leaving this page in case a personal detail affecting
    // the price (such as age) has been changed
    WorkingDocument workingDocument = getEventActiveWorkingDocument();
