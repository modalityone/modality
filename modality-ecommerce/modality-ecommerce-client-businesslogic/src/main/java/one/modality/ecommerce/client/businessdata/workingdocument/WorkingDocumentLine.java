...
public final class WorkingDocumentLine implements HasItemFamilyType {
  ...
  public WorkingDocumentLine(
      Option option, WorkingDocument workingDocument, DateTimeRange workingDocumentDateTimeRange) {
  ...
  public WorkingDocumentLine(
      DocumentLine documentLine, List<Attendance> attendances, EventAggregate eventAggregate) {
  ...
  private Option findDocumentLineOption(EventAggregate eventAggregate) {
    ...
    if (site != null && item != null)
      for (Option o : eventAggregate.getEventOptions())
        if (Entities.sameId(o.getSite(), site) && Entities.sameId(o.getItem(), item)) return o;
    return null;
  }
