...
module modality.ecommerce.payment.direct.buscall {
  ...
  provides dev.webfx.stack.com.bus.call.spi.BusCallEndpoint with
      ...
      one.modality.ecommerce.payment.direct.buscall.GetDirectPaymentGatewayInfosMethodEndpoint;
  provides dev.webfx.stack.com.serial.spi.SerialCodec with
      one.modality.ecommerce.payment.direct.buscall.serial.MakeDirectPaymentArgumentSerialCodec,
