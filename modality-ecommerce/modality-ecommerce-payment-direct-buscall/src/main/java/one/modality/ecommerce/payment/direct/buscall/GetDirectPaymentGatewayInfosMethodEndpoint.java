 ...
 * @author Bruno Salmon
 */
public final class GetDirectPaymentGatewayInfosMethodEndpoint
        extends AsyncFunctionBusCallEndpoint<
                GetDirectPaymentGatewayInfosArgument, GetDirectPaymentGatewayInfosResult> {

    public GetDirectPaymentGatewayInfosMethodEndpoint() {
        super(
                DirectPaymentServiceBusAddress.GET_DIRECT_PAYMENT_GATEWAY_INFOS_METHOD_ADDRESS,
                DirectPaymentService::getDirectPaymentGatewayInfos);
    }
}
