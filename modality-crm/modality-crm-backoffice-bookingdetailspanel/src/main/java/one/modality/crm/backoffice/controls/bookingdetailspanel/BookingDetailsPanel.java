...
public final class BookingDetailsPanel
    ...
    private Tab createFilterTab(String i18nKey, String dqlStatementString) {
        ...
        // The following is required only for gwt version for any reason (otherwise the table height
        // is not resized when growing)
                ...
                contextMenuActionGroupFactory =
                        () ->
                                newActionGroup(
                                        newOperationAction(
                                                () ->
                                                        new AddNewPaymentRequest(
                                                                getSelectedDocument(),
                                                                parentGetter.get())),
                                        newOperationAction(
                                                () ->
                                                        new AddNewTransferRequest(
                                                                getSelectedDocument(),
                                                                parentGetter.get())),
                                        newSeparatorActionGroup(
                                                newOperationAction(
    ...
    private Node buildPersonalDetailsView() {
        ...
        gridPane.getColumnConstraints()
                .setAll(
                        cc10p, cc10p, cc5p, cc5p, cc5p, cc10p, cc5p, cc10p, cc10p, cc5p, cc5p, cc5p,
                        cc10p, cc5p);
    ...
    private void addFieldLabelAndValue(
        ...
        ObservableValue<String> fieldValueProperty =
                FXProperties.compute(
                        ...
                        document -> {
                            Object fieldValue =
                                    document == null ? null : document.getFieldValue(fieldName);
                            if (fieldValue instanceof EntityId)
                                fieldValue =
                                        document.getForeignEntity(fieldName).getFieldValue("name");
                ...
                .bind(
                        FXProperties.compute(
                                ...
                                document ->
                                        document == null
                                                ? null
                                                : document.getStringFieldValue(commentField)));
