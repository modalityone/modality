...
public final class BookingDetailsPanel implements
    ...
    public Node buildUi() {
        ...
        container.setCenter(new TabPane(
            ...
            createFilterTab(BookingDetailsI18nKeys.Medias, "{class: 'MediaConsumption', columns: ['date',{expression: 'action', textAlign: 'center'},'mediaInfo'], where: 'attendance.documentLine.document=${selectedDocument}', orderBy: 'date desc'}"),
