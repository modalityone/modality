...
public final class FXOrganizationId {
    ...
    private static final ObjectProperty<EntityId> organizationIdProperty =
            new SimpleObjectProperty<>() {
                ...
                protected void invalidated() {
                    ...
                    if (session != null) {
                        session.put(
                                SESSION_ORGANIZATION_ID_KEY,
                                Entities.getPrimaryKey(organizationId));
                    ...
                    if (!Objects.equals(
                            organizationId,
                            FXOrganization.getOrganizationId())) { // Sync only if ids differ.
    ...
    static {
        ...
        FXProperties.runNowAndOnPropertiesChange(
                () -> {
                    Session session = FXSession.getSession();
                    Object primaryKey =
                            session == null ? null : session.get(SESSION_ORGANIZATION_ID_KEY);
