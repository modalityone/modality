...
module modality.crm.backoffice.organization.fx {
    ...
    requires modality.base.backoffice.application;
    ...
    // Provided services
    provides one.modality.base.backoffice.application.MainFrameHeaderNodeProvider with one.modality.crm.backoffice.organization.fx.impl.MainFrameHeaderOrganizationSelectorProvider;
