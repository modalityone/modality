...
public class OperationGroupsView {
    ...
    void showDeleteDialog(OperationGroup group) {
        ...
        // Title
        Label titleLabel = I18nControls.newLabel(OperationsAndRolesI18nKeys.DeleteGroup);
        ...
        // Confirmation text
        Label confirmLabel = I18nControls.newLabel(OperationsAndRolesI18nKeys.DeleteGroupConfirm);
