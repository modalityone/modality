...
final class OrganizationsRenderers {
    ...
    private static OrganizationsView organizationsView;

    static void setOrganizationsView(OrganizationsView view) {
    ...
    static void registerRenderers() {
        ...
        ValueRendererRegistry.registerValueRenderer("organizationStatus", (value, context) -> {
            ...
            statusLabel.setOnMouseClicked(e -> {
                if (organizationsView != null) {
                    organizationsView.toggleClosedStatus(organization);
                }
            });
        ...
        ValueRendererRegistry.registerValueRenderer("organizationActions", (value, context) -> {
            ...
            MonoPane editButton = SvgIcons.createButtonPane(editIcon, () -> {
                if (organizationsView != null) {
                    organizationsView.showEditDialog(organization);
                }
            });
