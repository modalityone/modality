...
module modality.crm.backoffice.activity.superadmin.plugin {
    ...
    provides dev.webfx.stack.routing.uirouter.operations.RouteRequestEmitter with one.modality.crm.backoffice.activities.superadmin.SuperAdminRouting.RouteToAdminRequestEmitter;
