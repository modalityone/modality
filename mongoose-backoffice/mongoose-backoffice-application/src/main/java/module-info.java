...
module mongoose.backoffice.application {
    ...
    // Exported packages
    exports mongoose.backoffice.application;

    // Provided services
    provides javafx.application.Application with mongoose.backoffice.application.MongooseBackOfficeApplication;
