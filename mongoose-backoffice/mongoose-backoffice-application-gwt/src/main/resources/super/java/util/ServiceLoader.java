...
public class ServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> ServiceLoader<S> load(Class<S> serviceClass) {
        switch (serviceClass.getName()) {
            ...
            case "dev.webfx.framework.client.operations.route.RouteRequestEmitter": return new ServiceLoader<S>(mongoose.backoffice.activities.authorizations.RouteToAuthorizationsRequestEmitter::new, mongoose.backoffice.activities.bookings.RouteToBookingsRequestEmitter::new, mongoose.backoffice.activities.diningareas.RouteToDiningAreasRequestEmitter::new, mongoose.backoffice.activities.statistics.RouteToStatisticsRequestEmitter::new, mongoose.backoffice.activities.events.RouteToEventsRequestEmitter::new, mongoose.backoffice.activities.income.RouteToIncomeRequestEmitter::new, mongoose.backoffice.activities.monitor.RouteToMonitorRequestEmitter::new, mongoose.backoffice.activities.letters.RouteToLettersRequestEmitter::new, mongoose.backoffice.activities.payments.RouteToPaymentsRequestEmitter::new, mongoose.backoffice.activities.roomsgraphic.RouteToRoomsGraphicRequestEmitter::new, mongoose.backoffice.activities.statements.RouteToStatementsRequestEmitter::new, mongoose.backoffice.activities.users.RouteToUsersRequestEmitter::new, mongoose.backoffice.activities.operations.RouteToOperationsRequestEmitter::new, mongoose.backoffice.activities.organizations.RouteToOrganizationsRequestEmitter::new);
            ...
            case "dev.webfx.framework.client.ui.uirouter.UiRoute": return new ServiceLoader<S>(mongoose.client.activities.login.LoginUiRoute::new, mongoose.client.activities.unauthorized.UnauthorizedUiRoute::new, mongoose.backoffice.activities.authorizations.AuthorizationsUiRoute::new, mongoose.backoffice.activities.bookings.BookingsUiRoute::new, mongoose.backoffice.activities.cloneevent.CloneEventUiRoute::new, mongoose.backoffice.activities.diningareas.DiningAreasUiRoute::new, mongoose.backoffice.activities.statistics.StatisticsUiRoute::new, mongoose.backoffice.activities.events.EventsUiRoute::new, mongoose.backoffice.activities.income.IncomeUiRoute::new, mongoose.backoffice.activities.monitor.MonitorUiRoute::new, mongoose.backoffice.activities.letters.LettersUiRoute::new, mongoose.backoffice.activities.letter.LetterUiRoute::new, mongoose.backoffice.activities.payments.PaymentsUiRoute::new, mongoose.backoffice.activities.roomsgraphic.RoomsGraphicUiRoute::new, mongoose.backoffice.activities.statements.StatementsUiRoute::new, mongoose.backoffice.activities.users.UsersUiRoute::new, mongoose.backoffice.activities.operations.OperationsUiRoute::new, mongoose.backoffice.activities.options.EditableOptionsUiRoute::new, mongoose.backoffice.activities.organizations.OrganizationsUiRoute::new);
            ...
            case "dev.webfx.platform.gwt.services.resource.spi.impl.GwtResourceBundle": return new ServiceLoader<S>(mongoose.backoffice.application.gwt.embed.EmbedResourcesBundle.ProvidedGwtResourceBundle::new);
            ...
            case "javafx.application.Application": return new ServiceLoader<S>(mongoose.backoffice.application.MongooseBackOfficeApplication::new);
