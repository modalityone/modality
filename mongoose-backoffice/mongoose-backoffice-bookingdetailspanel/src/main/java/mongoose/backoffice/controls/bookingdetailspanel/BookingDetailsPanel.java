package mongoose.backoffice.controls.bookingdetailspanel;
...
import mongoose.backoffice.controls.masterslave.UiBuilder;
import mongoose.backoffice.operations.entities.document.EditDocumentPersonalDetailsRequest;
import mongoose.backoffice.operations.entities.document.cart.OpenBookingCartRequest;
import mongoose.backoffice.operations.entities.document.multiplebookings.CancelOtherMultipleBookingsRequest;
import mongoose.backoffice.operations.entities.document.multiplebookings.GetBackCancelledMultipleBookingsDepositRequest;
import mongoose.backoffice.operations.entities.document.multiplebookings.MergeMultipleBookingsOptionsRequest;
import mongoose.backoffice.operations.entities.document.multiplebookings.ToggleMarkMultipleBookingRequest;
import mongoose.backoffice.operations.entities.documentline.AddNewDocumentLineRequest;
import mongoose.backoffice.operations.entities.documentline.DeleteDocumentLineRequest;
import mongoose.backoffice.operations.entities.documentline.EditDocumentLineRequest;
import mongoose.backoffice.operations.entities.documentline.ToggleCancelDocumentLineRequest;
import mongoose.backoffice.operations.entities.generic.CopyAllRequest;
import mongoose.backoffice.operations.entities.generic.CopySelectionRequest;
import mongoose.backoffice.operations.entities.mail.ComposeNewMailRequest;
import mongoose.backoffice.operations.entities.mail.OpenMailRequest;
import mongoose.backoffice.operations.entities.moneytransfer.AddNewPaymentRequest;
import mongoose.backoffice.operations.entities.moneytransfer.AddNewTransferRequest;
import mongoose.backoffice.operations.entities.moneytransfer.DeletePaymentRequest;
import mongoose.backoffice.operations.entities.moneytransfer.EditPaymentRequest;
