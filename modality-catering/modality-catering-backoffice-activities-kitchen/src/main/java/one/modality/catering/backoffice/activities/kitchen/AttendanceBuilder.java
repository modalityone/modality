...
public class AttendanceBuilder {
    ...
    public AttendanceBuilder(ReactiveVisualMapper<DocumentLine> leftDocumentLineVisualMapper, ReactiveVisualMapper<Attendance> rightAttendanceVisualMapper, Property<VisualResult> finalVisualResultProperty) {
    ...
    public AttendanceBuilder start() {
    ...
    private void buildFinalVisualResultIfReady() {
        ...
        System.out.println("rightAttendances.size() = " + rightAttendances.size());
