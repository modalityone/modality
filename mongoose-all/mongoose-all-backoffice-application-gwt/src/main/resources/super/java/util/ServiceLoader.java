...
public class ServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> ServiceLoader<S> load(Class<S> serviceClass) {
        switch (serviceClass.getName()) {
            ...
            case "dev.webfx.framework.client.operations.route.RouteRequestEmitter": return new ServiceLoader<S>(mongoose.crm.backoffice.activities.authorizations.RouteToAuthorizationsRequestEmitter::new, mongoose.ecommerce.backoffice.activities.bookings.RouteToBookingsRequestEmitter::new, mongoose.catering.backoffice.activities.diningareas.RouteToDiningAreasRequestEmitter::new, mongoose.ecommerce.backoffice.activities.statistics.RouteToStatisticsRequestEmitter::new, mongoose.event.backoffice.activities.events.RouteToEventsRequestEmitter::new, mongoose.ecommerce.backoffice.activities.income.RouteToIncomeRequestEmitter::new, mongoose.base.backoffice.activities.monitor.RouteToMonitorRequestEmitter::new, mongoose.crm.backoffice.activities.letters.RouteToLettersRequestEmitter::new, mongoose.ecommerce.backoffice.activities.payments.RouteToPaymentsRequestEmitter::new, mongoose.hotel.backoffice.activities.roomsgraphic.RouteToRoomsGraphicRequestEmitter::new, mongoose.ecommerce.backoffice.activities.statements.RouteToStatementsRequestEmitter::new, mongoose.crm.backoffice.activities.users.RouteToUsersRequestEmitter::new, mongoose.base.backoffice.activities.operations.RouteToOperationsRequestEmitter::new, mongoose.crm.backoffice.activities.organizations.RouteToOrganizationsRequestEmitter::new);
            ...
            case "dev.webfx.framework.client.ui.uirouter.UiRoute": return new ServiceLoader<S>(mongoose.crm.client.activities.login.LoginUiRoute::new, mongoose.crm.client.activities.unauthorized.UnauthorizedUiRoute::new, mongoose.crm.backoffice.activities.authorizations.AuthorizationsUiRoute::new, mongoose.ecommerce.backoffice.activities.bookings.BookingsUiRoute::new, mongoose.event.backoffice.activities.cloneevent.CloneEventUiRoute::new, mongoose.catering.backoffice.activities.diningareas.DiningAreasUiRoute::new, mongoose.ecommerce.backoffice.activities.statistics.StatisticsUiRoute::new, mongoose.event.backoffice.activities.events.EventsUiRoute::new, mongoose.ecommerce.backoffice.activities.income.IncomeUiRoute::new, mongoose.base.backoffice.activities.monitor.MonitorUiRoute::new, mongoose.crm.backoffice.activities.letters.LettersUiRoute::new, mongoose.crm.backoffice.activities.letter.LetterUiRoute::new, mongoose.ecommerce.backoffice.activities.payments.PaymentsUiRoute::new, mongoose.hotel.backoffice.activities.roomsgraphic.RoomsGraphicUiRoute::new, mongoose.ecommerce.backoffice.activities.statements.StatementsUiRoute::new, mongoose.crm.backoffice.activities.users.UsersUiRoute::new, mongoose.base.backoffice.activities.operations.OperationsUiRoute::new, mongoose.event.backoffice.activities.options.EditableOptionsUiRoute::new, mongoose.crm.backoffice.activities.organizations.OrganizationsUiRoute::new);
            ...
            case "dev.webfx.platform.shared.services.appcontainer.spi.ApplicationJob": return new ServiceLoader<S>(mongoose.base.client.jobs.sessionrecorder.ClientSessionRecorderJob::new, dev.webfx.framework.client.jobs.querypush.QueryPushClientJob::new);
            case "dev.webfx.platform.shared.services.appcontainer.spi.ApplicationModuleInitializer": return new ServiceLoader<S>(dev.webfx.kit.launcher.WebFxKitLauncherModuleInitializer::new, dev.webfx.platform.shared.services.appcontainer.spi.impl.ApplicationJobsStarter::new, dev.webfx.platform.shared.services.serial.SerialCodecModuleInitializer::new, dev.webfx.platform.shared.services.buscall.BusCallModuleInitializer::new, mongoose.base.client.operationactionsloading.MongooseClientOperationActionsLoader::new, dev.webfx.framework.shared.interceptors.dqlquery.DqlQueryInterceptorModuleInitializer::new, dev.webfx.framework.shared.interceptors.dqlquerypush.DqlQueryPushInterceptorModuleInitializer::new, dev.webfx.framework.shared.interceptors.dqlsubmit.DqlSubmitInterceptorModuleInitializer::new, dev.webfx.platform.gwt.services.resource.spi.impl.GwtResourceModuleInitializer::new);
