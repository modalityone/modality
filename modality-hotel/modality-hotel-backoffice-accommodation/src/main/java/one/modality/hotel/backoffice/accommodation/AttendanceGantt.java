...
public class AttendanceGantt extends AccommodationGantt<AttendanceBlock> {
    ...
    protected void drawBar(LocalDateBar<AttendanceBlock> bar, Bounds b, GraphicsContext gc) {
        // The bar wraps a block over 1 or several days (or always 1 day if the user hasn't ticked
        // the grouping block
        ...
        barDrawer
                ...
                // First draw the un-clipped text in a dark colour which contrasts with the
                // background of the chart
                .setClipText(false)
                .setTextFill(Color.GRAY)
                .drawBar(b, gc)
                // Second draw the clipped text in a light colour which contrasts with the
