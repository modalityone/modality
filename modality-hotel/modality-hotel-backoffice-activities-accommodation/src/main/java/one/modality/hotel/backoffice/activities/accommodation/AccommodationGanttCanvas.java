...
public class AccommodationGanttCanvas {
    ...
    static final Paint ROOM_ICON_SVG_FILL = Color.web("#838788");
    static final double ROOM_ICON_SVG_WIDTH = 20.3;
    static final double ROOM_ICON_SVG_HEIGHT = 16;
    ...
    public void startLogic(Object mixin) {
        ...
        ReactiveEntitiesMapper.<Attendance>createPushReactiveChain(mixin)
                .always("{class: 'Attendance', alias: 'a', fields: 'date,documentLine.document.(person_firstName,person_lastName,event.id),scheduledResource.configuration.(name,item.name),documentLine.document.event.name'}")
