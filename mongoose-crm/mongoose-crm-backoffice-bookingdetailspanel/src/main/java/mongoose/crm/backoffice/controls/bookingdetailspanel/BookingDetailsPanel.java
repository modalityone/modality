package mongoose.crm.backoffice.controls.bookingdetailspanel;
...
import mongoose.base.backoffice.controls.masterslave.UiBuilder;
import mongoose.ecommerce.backoffice.operations.entities.document.EditDocumentPersonalDetailsRequest;
import mongoose.ecommerce.backoffice.operations.entities.document.cart.OpenBookingCartRequest;
import mongoose.ecommerce.backoffice.operations.entities.document.multiplebookings.CancelOtherMultipleBookingsRequest;
import mongoose.ecommerce.backoffice.operations.entities.document.multiplebookings.GetBackCancelledMultipleBookingsDepositRequest;
import mongoose.ecommerce.backoffice.operations.entities.document.multiplebookings.MergeMultipleBookingsOptionsRequest;
import mongoose.ecommerce.backoffice.operations.entities.document.multiplebookings.ToggleMarkMultipleBookingRequest;
import mongoose.ecommerce.backoffice.operations.entities.documentline.AddNewDocumentLineRequest;
import mongoose.ecommerce.backoffice.operations.entities.documentline.DeleteDocumentLineRequest;
import mongoose.ecommerce.backoffice.operations.entities.documentline.EditDocumentLineRequest;
import mongoose.ecommerce.backoffice.operations.entities.documentline.ToggleCancelDocumentLineRequest;
...
import mongoose.crm.backoffice.operations.entities.mail.ComposeNewMailRequest;
import mongoose.crm.backoffice.operations.entities.mail.OpenMailRequest;
import mongoose.ecommerce.backoffice.operations.entities.moneytransfer.AddNewPaymentRequest;
import mongoose.ecommerce.backoffice.operations.entities.moneytransfer.AddNewTransferRequest;
import mongoose.ecommerce.backoffice.operations.entities.moneytransfer.DeletePaymentRequest;
import mongoose.ecommerce.backoffice.operations.entities.moneytransfer.EditPaymentRequest;
