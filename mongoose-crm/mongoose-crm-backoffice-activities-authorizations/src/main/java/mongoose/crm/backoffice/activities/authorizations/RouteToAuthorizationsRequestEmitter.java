package mongoose.crm.backoffice.activities.authorizations;

import mongoose.crm.backoffice.activities.operations.authorizations.RouteToAuthorizationsRequest;
