...
public final class AddNewFieldsRequest
        implements HasOperationCode, HasOperationExecutor<AddNewFieldsRequest, Void> {

    private static final String OPERATION_CODE = "AddNewFields";
