...
public class TimeTheme implements Theme {
    ...
    public void styleFacet(Facet facet, Object facetCategory) {
        ...
        if (text != null && textFill != null)
            ThemeUtil.applyTextFill(text, textFill);
    ...
    // =================================================================================================================
    // === Public methods called by styleFacet() that can also be called externally (typically for canvas operation) ===
    // =================================================================================================================
    ...
    // =================================================================================================================
    // ===         Public methods designed to be called externally only (typically for canvas operation)             ===
    // =================================================================================================================
    // -> because these methods are requesting a style information that depends on other themes (this is why styleFacet()
    // makes calls to ThemeRegistry.styleFacetNow() in these cases before adding its proper style on top of that).
    // So to reply to these external calls, these methods actually call styleFacet() with a generic facet, capture the
