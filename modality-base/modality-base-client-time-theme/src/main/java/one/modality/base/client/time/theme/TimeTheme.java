...
public class TimeTheme implements Theme {
    ...
    private static final Color ESSENTIAL_MONTH_BACKGROUND_COLOR_UNSELECTED =
            Color.rgb(131, 135, 136);
    ...
    static {
        ...
        VARIED_MONTH_BACKGROUND_COLORS_SELECTED =
                IntStream.range(0, 12)
                        .mapToObj(i -> monthColorSeries.nextColor())
                        .toArray(Color[]::new);
        ...
        VARIED_LIGHT_DAY_OF_WEEK_BACKGROUND_COLORS =
                IntStream.range(0, 7)
                        .mapToObj(i -> weekDayColorSeries.nextColor())
                        .toArray(Color[]::new);
            ...
            case MONTH_FACET:
                {
                    ...
                    if (logicValue instanceof YearMonth)
                        backgroundColor =
                                getMonthBackgroundColor((YearMonth) logicValue, facet.isSelected());
                    else if (logicValue instanceof Month)
                        backgroundColor =
                                getMonthBackgroundColor((Month) logicValue, facet.isSelected());
            ...
            case DAY_OF_WEEK_FACET:
                {
                    ...
                    ThemeRegistry.styleFacetNow(
                            facet, LuminanceFacetCategory.SECONDARY_PANEL_FACET);
                    if (facet.isSelected()) {
            ...
            case DATE_PANEL_FACET:
                {
                    ...
                    if (FXPaletteMode.isVariedPalette()) {
                        textFill = getMonthTextColor();
                        backgroundColor =
                                getDatePanelBackgroundColor((Object) facet.getLogicValue());
                    }
                    break;
                }
    ...
    // operation)             ===
    // =================================================================================================================
    // -> because these methods are requesting a style information that depends on other themes
    // (this is why styleFacet()
    ...
    public static Paint getDayOfWeekCanvasBackgroundColor(Object logicalValue, boolean selected) {
        return StyleCapture.captureStyle(
                        TIME_THEME, logicalValue, selected, DAY_OF_WEEK_CANVAS_FACET)
                .getBackgroundFill();
    }
