...
public final class MultiLanguageEditor {
    ...
    public MultiLanguageEditor(
        ...
        StringBuilder sb =
                domainClassIdOrLoadingSelect == null
                                || domainClassIdOrLoadingSelect.startsWith("select ")
                        ? null
    ...
    private MonoLanguageEditor getCurrentMonoLanguageEditor() {
        ...
        Object language =
                selectedLanguageButton != null
                        ? selectedLanguageButton.getUserData()
                        : I18n.getLanguage();
    ...
    private final class MonoLanguageEditor {
        ...
        private final Button revertButton =
                buttonFactory.newButton(
                        closeCallback != null ? CANCEL_ACTION_KEY : REVERT_ACTION_KEY,
                        this::revert);
        ...
        String format(String editorText) {
            if (editorText != null) {
                ...
                if (editorText.startsWith("<p>")
                        && editorText.indexOf("</p>") == editorText.length() - 4)
        ...
        void displayEditor() {
            if (borderPane.getCenter() != editor) {
                ...
                // The following code is just a temporary workaround to make CKEditor work in html
                // platform (to be removed once fixed)
                if (editedEntity != null) {
                    editor.resize(1, 1);
