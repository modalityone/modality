 ...
 * @author Bruno Salmon
 */
public final class ModalityLocalDataSourceConfigurationConsumer extends DefaultResourceConfigurationConsumer {

    private final static String CONFIGURATION_NAME = "ModalityDatabase";
    private final static String DEFAULT_CONFIGURATION_RESOURCE_FILE_NAME = "ModalityDatabase.default.json";
    ...
    public Future<Void> boot(ReadOnlyKeyObject config) {
        if (config == null)
            return Future.failedFuture("WARNING: No connection details found for Modality data source");
