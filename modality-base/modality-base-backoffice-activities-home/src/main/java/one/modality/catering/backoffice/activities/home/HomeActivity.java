...
public class HomeActivity extends ViewDomainActivityBase
  ...
  static class Tile extends Pane {
    ...
    public Tile(Action action) {
      this.action = action;
      luminanceFacet = LuminanceTheme.createSecondaryPanelFacet(this).setShadowed(true).style();
      textFacet =
      ...
      FXProperties.runNowAndOnPropertiesChange(
          this::onActionPropertiesChanged, action.textProperty(), action.graphicProperty());
    }
