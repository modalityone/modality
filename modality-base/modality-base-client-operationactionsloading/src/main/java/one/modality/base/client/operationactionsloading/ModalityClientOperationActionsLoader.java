    ...
    EntityStore.create(DataSourceModelService.getDefaultDataSourceModel())
        ...
        .onSuccess(
            operations -> {
                    ...
                    isPublic
                        ...
                        : newAuthAction(
                            ...
                            registry.authorizedOperationActionProperty(
                                operationCode, AuthorizationFactory::isAuthorized));
              ...
              // Telling the registry how to update the graphical properties when needed (ex:
              // ToggleCancel actions text
              // needs to be updated to say 'Cancel' or 'Uncancel' on selection change)
              registry.setOperationActionGraphicalPropertiesUpdater(
                  operationAction -> {
                    // Actually since text and graphic properties come from I18n, we just need to
                    // inform it about the
                    // change, and it will refresh all translations, including therefore these
                    // graphical properties.
                    // The possible expressions used by operations like ToggleCancel will be
                    // recomputed through this
                    // refresh thanks to the I18n evaluation system.
                    // Instantiating an operation request just to have the request class or
                    // operation code
                    ...
                    Action graphicalAction =
                        registry.getGraphicalActionFromOperationRequest(operationRequest);
