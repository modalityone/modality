...
public class ModalityActions {
  ...
  public static void registerActions() {
    ...
    registerAction(
        VISIT_FEES_ACTION_KEY, VISIT_FEES_ACTION_KEY, ModalityIcons.priceTagMonoSvg16JsonUrl);
    registerAction(
        VISIT_TERMS_AND_CONDITIONS_ACTION_KEY,
        VISIT_TERMS_AND_CONDITIONS_ACTION_KEY,
        ModalityIcons.certificateMonoSvg16JsonUrl);
    registerAction(
        VISIT_PROGRAM_ACTION_KEY, VISIT_PROGRAM_ACTION_KEY, ModalityIcons.calendarMonoSvg16JsonUrl);
