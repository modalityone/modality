package org.modality_project.base.client.activity.themes;
...
public final class LightTheme implements ThemeProvider {
    ...
    public void apply() {
        ...
        Theme.setDialogBackground(BackgroundFactory.newVerticalLinearGradientBackground("#e0e0e0", "#e9e9e9",10, 1));
