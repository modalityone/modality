...
final class SetEntityFieldExecutor {
  ...
  private static Future<Void> execute(
    ...
    if (confirmationText == null)
      ...
      DialogUtil.armDialogContentButtons(
          ...
          dialogCallback ->
              updateAndSave(
                  entity, leftExpression, rightExpression, dialogCallback, parentContainer));
    }
  ...
  private static void updateAndSave(
      ...
      Pane parentContainer) {
    entity
        .onExpressionLoaded(rightExpression)
        ...
        .onSuccess(
            v -> {
              ...
              leftExpression.setValue(
                  updateEntity,
                  rightExpression.evaluate(updateEntity, updateStore.getEntityDataWriter()),
              ...
              updateStore
                  ...
                  .onComplete(
                      ar2 -> {
                        ...
                        else if (dialogCallback != null) dialogCallback.closeDialog();
                      });
            });
  }
