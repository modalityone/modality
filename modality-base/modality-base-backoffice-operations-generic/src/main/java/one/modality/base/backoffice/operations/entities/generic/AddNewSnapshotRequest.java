...
public final class AddNewSnapshotRequest
    implements HasOperationCode, HasOperationExecutor<AddNewSnapshotRequest, Void> {

  private static final String OPERATION_CODE = "AddNewSnapshot";

  private final Collection<? extends Entity> entities;
  private final Organization organization;
  private final Pane parentContainer;

  public AddNewSnapshotRequest(
      Collection<? extends Entity> entities, Organization organization, Pane parentContainer) {
