...
public class GroupMasterSlaveView extends MasterSlaveView {
    ...
    public boolean isMasterVisible() {
        // Note: masterVisibleProperty is null on first call because not yet initialized
        // (constructor -> set master/slave view -> updateView() -> isMasterVisible())
        ...
        masterVisibleProperty()
                .bind(
                        FXProperties.combine(
                                ...
                                (groupVisible, selectedGroup) ->
                                        !groupVisible || selectedGroup != null));
    ...
    public static <
                    E extends Entity,
                    PM extends HasGroupVisualResultProperty & HasSelectedMasterProperty<E>>
            GroupMasterSlaveView createAndBind(
    ...
    public static <E extends Entity> GroupMasterSlaveView createAndBind(
        ...
        return createAndBind(
                groupView,
                masterView.buildUi(),
                slaveView == null ? null : slaveView.buildUi(),
                pm);
    }
