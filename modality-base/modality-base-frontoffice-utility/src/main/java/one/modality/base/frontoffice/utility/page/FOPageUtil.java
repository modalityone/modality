...
public final class FOPageUtil {
    ...
    public static final double BOTTOM_PAGE_INSETS = 120; /* = space between the last node of the page (ex: Help Panel)
      and the footer. 120 is the last value computed, to fit well in particular on the Video page, where the HelpPanel
      has a breathing space above of 90 pixels = 50 (padding top) + 40 (VBox spacing). We repeat that same breathing
      space under the HelpPanel, and we add an extra 30 pixels (looks better) before the footer logo. */
