 ...
 * @author Bruno Salmon
 */
public final class EventsPresentationModel
        extends OrganizationDependentGenericTablePresentationModel
        implements TimeWindow<LocalDate> {

    // Display input

    private final BooleanProperty withBookingsProperty =
            new SimpleBooleanProperty(true); // Limit initially set to true

    public BooleanProperty withBookingsProperty() {
        return withBookingsProperty;
    }
