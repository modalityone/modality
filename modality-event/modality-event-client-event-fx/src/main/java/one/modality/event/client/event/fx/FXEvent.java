...
public final class FXEvent {
    ...
    public static final String EXPECTED_FIELDS = "icon, name, startDate, endDate, type.recurringItem, teachingsDayTicket, audioRecordingsDayTicket, organization.(" + FXOrganization.EXPECTED_FIELDS + "), venue, state, livestreamMessageLabel, shortDescriptionLabel";
