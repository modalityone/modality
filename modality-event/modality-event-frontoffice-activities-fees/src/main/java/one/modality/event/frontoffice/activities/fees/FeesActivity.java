...
final class FeesActivity extends BookingProcessActivity {
    ...
    private void displayFeesGroupsNow() {
        ...
        VisualResultBuilder rsb =
                VisualResultBuilder.create(
                        ...
                        new VisualColumn[] {
                            VisualColumn.create(
                                    (value, context) ->
                                            renderFeesGroupHeader(
                                                    (Pair<ReadOnlyJsonObject, String>) value)),
                            VisualColumn.create(
                                    (value, context) -> renderFeesGroupBody((VisualResult) value)),
        ...
        for (int i = 0; i < n; i++) {
            ...
            rsb.setValue(
                    i,
                    1,
                    generateFeesGroupVisualResult(
                            feesGroup, this::onBookButtonPressed, cumulators));
    ...
    private VisualResult generateFeesGroupVisualResult(
                        ...
                        VisualColumnBuilder.create(I18n.getI18nText("Availability"))
                                ...
                                .setValueRenderer(
                                        (p, context) -> {
                                            ...
                                            if (pair == null
                                                    || !eventAggregate
                                                            .areEventAvailabilitiesLoaded())
                                                return new ImageView(
                                                        ImageStore.getOrCreateImage(
                                                                ModalityIcons.spinnerIcon16Url,
                                                                16,
                                                                16));
                                            Object availability = pair.get1();
                                            OptionsPreselection optionsPreselection = pair.get2();
                                            // Availability is null when there is no online room at
                                            // all. In this case...
                                            ...
                                            button.setOnAction(
                                                    e -> bookHandler.accept(optionsPreselection));
                                                                    ...
                                                                    .collateNodes(
                                                                            createBadge(
                                                                                    TextRenderer
                                                                                            ...
                                                                                            .renderValue(
                                                                                                    availability,
                                                                                                    ValueRenderingContext
                                                                                                            .DEFAULT_READONLY_CONTEXT)),
                                                                            button);
        ...
        for (OptionsPreselection optionsPreselection : optionsPreselections) {
                    ...
                    singleOption
                            ? /* Showing course name instead of 'NoAccommodation' when single line */ Labels
                                    .instantTranslateLabel(
                                            Objects.coalesce(
                                                    feesGroup.getLabel(),
                                                    Labels.bestLabelOrName(feesGroup.getEvent())))
                            : /* Otherwise showing accommodation type */ optionsPreselection
                                    .getDisplayName());
            ...
            rsb.setValue(
                    ...
                    2,
                    new Pair<>(
                            optionsPreselection.getDisplayAvailability(eventAggregate),
                            optionsPreselection));
        }
        return rsb.build();
    }
    ...
    private Node renderFeesGroupHeader(Pair<ReadOnlyJsonObject, String> pair) {
        ...
        RadioButton noDiscountRadio =
                hasDiscountRates
                        ? I18nControls.setI18nProperties(new RadioButton(), "NoDiscount")
                        : null;
        ...
        if (noDiscountRadio != null) {
            noDiscountRadio.setSelected(
                    Booleans.isNotTrue(person.isUnemployed())
                            && Booleans.isNotTrue(person.isFacilityFee()));
            noDiscountRadio
                    .selectedProperty()
                    .addListener(
