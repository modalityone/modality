...
final class Step2PaymentSlide extends StepSlide {
    ...
    public void buildSlideUi() {
        ...
        I18n.bindI18nTextProperty(paymentInformationHtmlText.textProperty(), BookI18nKeys.PaymentInformation1, webPaymentForm.getGatewayName());
        ...
        webPaymentForm
            .setOnLoadFailure(errorMsg -> {
                displayErrorMessage(BookI18nKeys.ErrorWhileLoadingPaymentForm);
                Console.log(errorMsg);
            })
            .setOnInitFailure(errorMsg -> {
                displayErrorMessage(BookI18nKeys.ErrorWhileInitializingHTMLPaymentForm);
                Console.log(errorMsg);
            })
            .setOnVerificationFailure(errorMsg -> {
                displayErrorMessage(BookI18nKeys.ErrorPaymentGatewayFailure);
                Console.log(errorMsg);
            })
            .setOnPaymentFailure(errorMsg -> {
                displayErrorMessage(BookI18nKeys.ErrorPaymentModalityFailure);
                Console.log(errorMsg);
            })
