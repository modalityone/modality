...
final class Step5CancellationSlide extends StepSlide {
    ...
    public void setCancelPaymentResult(CancelPaymentResult cancelPaymentResult) {
        ...
        if (cancelPaymentResult.isBookingCancelled()) {
            I18nControls.bindI18nProperties(message, BookI18nKeys.PaymentAndBookingCancelled);
            I18nControls.bindI18nProperties(button, BookI18nKeys.UncancelBooking);
        } else {
            I18nControls.bindI18nProperties(message, BookI18nKeys.PaymentCancelled);
            I18nControls.bindI18nProperties(button, BookI18nKeys.BookAgain);
        }
    }
}
