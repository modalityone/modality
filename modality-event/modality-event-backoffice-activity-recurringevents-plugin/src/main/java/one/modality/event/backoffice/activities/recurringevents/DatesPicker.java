...
public class DatesPicker
{
    ...
    private Function<LocalDate, Color> computeColorFunction = new Function<LocalDate, Color>() {
        @Override
        public Color apply(LocalDate localDate) {
            return getSelectedDateColor();
        }
    };
    ...
    public ObjectProperty<Color> selectedDateColorProperty() {
        return selectedDateColorProperty;
    }
    ...
    public void setSelectedDateColor(Color color) {
        this.selectedDateColorProperty.set(color);
    }
    ...
    protected Node createDateNode(LocalDate date) {
    ...
    protected void changeBackgroundWhenSelected(LocalDate currentDate,boolean isSelected)
    {
        ...
        Pair LabelColor = dateLabelAndColorMap.get(currentDate);
        Label label = (Label) LabelColor.get1();
        Color color = (Color) LabelColor.get2();
    ...
    protected Node createDayOfWeekNode(DayOfWeek date) {
        Label currentDayLabel = new Label();
        int size = 20;
        currentDayLabel.setMaxSize(size,size);
        currentDayLabel.setMinSize(size,size);
