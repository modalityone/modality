...
public interface MediasI18nKeys {
    ...
    String AvailableUntilComment = "AvailableUntilComment";
    ...
    String PublishMessage = "PublishMessage";
    String VODAvailableAfter = "VODAvailableAfter";
    String VODAvailableAfterComment = "VODAvailableAfterComment";
    String VODComment = "VODComment";
    String VODPromptComment = "VODPromptComment";
