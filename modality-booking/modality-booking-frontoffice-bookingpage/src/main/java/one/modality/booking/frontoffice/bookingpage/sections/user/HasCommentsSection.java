...
public interface HasCommentsSection extends BookingFormSection {
     ...
     * Changes in the section will be pushed to the state, and the section
     * will be reset when the state is reset.
     *
    ...
    default void bindToSelectionState(BookingSelectionState selectionState) {
        ...
        // Bidirectional binding: section <-> state
        commentTextProperty().bindBidirectional(selectionState.commentTextProperty());
    }
}
