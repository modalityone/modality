...
public class PaymentRefusedSection implements BookingFormSection {
    ...
    private VBox buildDeclineReasonCard() {
        ...
        iconCircle.setStyle("-fx-background-color: #FEF3C7; -fx-background-radius: 16;");
    ...
    private VBox buildPayLaterInfoBox() {
        ...
        box.setStyle("-fx-background-color: #F8F9FA; -fx-border-color: #E6E7E7; -fx-border-radius: 12; -fx-background-radius: 12;");
