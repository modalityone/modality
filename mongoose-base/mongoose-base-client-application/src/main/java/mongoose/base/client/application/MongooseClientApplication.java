package mongoose.base.client.application;
...
public class MongooseClientApplication extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        scene.getStylesheets().addAll("mongoose/base/client/css/mongoose.css");
    ...
    private void setLoadingSpinnerVisible(boolean visible) {
        ...
        if (root instanceof Pane) {
            ...
            if (!visible) {
                ...
                if (spinner == null) {
                    spinner = ImageStore.createImageView("mongoose/base/client/images/spinner.gif");
