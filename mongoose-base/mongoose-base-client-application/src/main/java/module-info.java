...
module mongoose.base.client.application {
    ...
    requires mongoose.base.client.busconfig;
    requires mongoose.base.client.css;
    requires mongoose.base.client.i18n;
    requires mongoose.base.client.icons;
    requires mongoose.base.client.operationactionsloading;
    requires mongoose.base.client.sessionrecorder;
    requires mongoose.crm.client.activities.login;
    requires mongoose.crm.client.activities.unauthorized;
    requires mongoose.crm.client.authz;
