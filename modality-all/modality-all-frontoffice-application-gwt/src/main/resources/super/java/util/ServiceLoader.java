...
public class ServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> ServiceLoader<S> load(Class<S> serviceClass) {
        switch (serviceClass.getName()) {
            ...
            case "dev.webfx.stack.auth.authz.client.spi.AuthorizationClientServiceProvider": return new ServiceLoader<S>(one.modality.crm.client.services.authz.ModalityAuthorizationClientServiceProvider::new);
            case "dev.webfx.stack.auth.login.spi.LoginServiceProvider": return new ServiceLoader<S>(dev.webfx.stack.auth.login.spi.impl.remote.RemoteLoginServiceProvider::new);
            case "dev.webfx.stack.auth.login.ui.spi.LoginUiProvider": return new ServiceLoader<S>(dev.webfx.stack.auth.login.ui.spi.impl.webthirdparty.WebThirdPartyLoginUiProvider::new);
            case "dev.webfx.stack.com.bus.call.spi.BusCallEndpoint": return new ServiceLoader<S>(dev.webfx.stack.auth.authn.buscall.AuthenticateMethodEndpoint::new, dev.webfx.stack.auth.authn.buscall.GetUserClaimsMethodEndpoint::new, dev.webfx.stack.auth.login.buscall.GetLoginUiInputMethodEndpoint::new, dev.webfx.stack.db.query.buscall.ExecuteQueryBatchMethodEndpoint::new, dev.webfx.stack.db.query.buscall.ExecuteQueryMethodEndpoint::new, dev.webfx.stack.db.querypush.buscall.ExecuteQueryPushMethodEndpoint::new, dev.webfx.stack.db.submit.buscall.ExecuteSubmitBatchMethodEndpoint::new, dev.webfx.stack.db.submit.buscall.ExecuteSubmitMethodEndpoint::new);
