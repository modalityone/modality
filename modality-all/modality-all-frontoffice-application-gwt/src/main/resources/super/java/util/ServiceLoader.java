...
public class ServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> ServiceLoader<S> load(Class<S> serviceClass) {
        switch (serviceClass.getName()) {
            case "dev.webfx.framework.client.operations.i18n.ChangeLanguageRequestEmitter": return new ServiceLoader<S>(org.modality_project.base.client.operations.i18n.ChangeLanguageToEnglishRequest.ProvidedEmitter::new, org.modality_project.base.client.operations.i18n.ChangeLanguageToFrenchRequest.ProvidedEmitter::new);
            case "dev.webfx.framework.client.operations.route.RouteRequestEmitter": return new ServiceLoader<S>();
            case "dev.webfx.framework.client.services.i18n.spi.I18nProvider": return new ServiceLoader<S>(org.modality_project.base.client.services.i18n.MongooseI18nProvider::new);
            ...
            case "javafx.application.Application": return new ServiceLoader<S>(org.modality_project.all.frontoffice.application.MongooseFrontOfficeApplication::new);
