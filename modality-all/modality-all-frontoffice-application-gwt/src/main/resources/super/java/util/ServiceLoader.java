...
public class ServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> ServiceLoader<S> load(Class<S> serviceClass) {
        switch (serviceClass.getName()) {
            ...
            case "dev.webfx.platform.browser.spi.BrowserProvider": return new ServiceLoader<S>(dev.webfx.platform.browser.spi.impl.gwt.GwtBrowserProvider::new);
