...
public class ServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> ServiceLoader<S> load(Class<S> serviceClass) {
        switch (serviceClass.getName()) {
            ...
            case "dev.webfx.framework.client.services.i18n.spi.I18nProvider": return new ServiceLoader<S>(org.modality_project.base.client.services.i18n.ModalityI18nProvider::new);
            ...
            case "dev.webfx.framework.shared.services.authn.spi.AuthenticationServiceProvider": return new ServiceLoader<S>(org.modality_project.crm.client.services.authn.ModalityAuthenticationServiceProvider::new);
            case "dev.webfx.framework.shared.services.authz.spi.AuthorizationServiceProvider": return new ServiceLoader<S>(org.modality_project.crm.client.services.authz.ModalityAuthorizationServiceProvider::new);
            case "dev.webfx.framework.shared.services.datasourcemodel.spi.DataSourceModelProvider": return new ServiceLoader<S>(org.modality_project.base.shared.services.datasourcemodel.ModalityDataSourceModelProvider::new);
            case "dev.webfx.framework.shared.services.domainmodel.spi.DomainModelProvider": return new ServiceLoader<S>(org.modality_project.base.shared.services.domainmodel.ModalityDomainModelProvider::new);
