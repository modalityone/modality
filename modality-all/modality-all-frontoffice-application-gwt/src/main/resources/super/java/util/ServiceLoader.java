...
public class ServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> ServiceLoader<S> load(Class<S> serviceClass) {
        switch (serviceClass.getName()) {
            ...
            case "dev.webfx.stack.routing.uirouter.UiRoute": return new ServiceLoader<S>(one.modality.crm.client.activities.login.LoginUiRoute::new, one.modality.crm.client.activities.unauthorized.UnauthorizedUiRoute::new, one.modality.event.frontoffice.activities.account.AccountFriendsAndFamilyEditUiRoute::new, one.modality.event.frontoffice.activities.account.AccountFriendsAndFamilyUiRoute::new, one.modality.event.frontoffice.activities.account.AccountPersonalInformationUiRoute::new, one.modality.event.frontoffice.activities.account.AccountSettingsUiRoute::new, one.modality.event.frontoffice.activities.account.AccountUiRoute::new, one.modality.event.frontoffice.activities.alerts.AlertsUiRoute::new, one.modality.event.frontoffice.activities.booking.BookingUiRoute::new, one.modality.event.frontoffice.activities.home.HomeNewsArticleUiRoute::new, one.modality.event.frontoffice.activities.home.HomeUiRoute::new);
            case "dev.webfx.stack.routing.uirouter.operations.RouteRequestEmitter": return new ServiceLoader<S>(one.modality.event.frontoffice.activities.account.RouteToAccountFriendsAndFamilyEditEmitter::new, one.modality.event.frontoffice.activities.account.RouteToAccountFriendsAndFamilyEmitter::new, one.modality.event.frontoffice.activities.account.RouteToAccountPersonalInformationEmitter::new, one.modality.event.frontoffice.activities.account.RouteToAccountRequestEmitter::new, one.modality.event.frontoffice.activities.account.RouteToAccountSettingsRequestEmitter::new, one.modality.event.frontoffice.activities.alerts.RouteToAlertsRequestEmitter::new, one.modality.event.frontoffice.activities.booking.RouteToBookingRequestEmitter::new, one.modality.event.frontoffice.activities.home.RouteToHomeNewsArticleRequestEmitter::new, one.modality.event.frontoffice.activities.home.RouteToHomeRequestEmitter::new);
