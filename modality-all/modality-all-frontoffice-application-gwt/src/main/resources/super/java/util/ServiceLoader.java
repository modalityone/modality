...
public class ServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> ServiceLoader<S> load(Class<S> serviceClass) {
        switch (serviceClass.getName()) {
            ...
            case "dev.webfx.kit.statusbar.spi.StatusBarProvider": return new ServiceLoader<S>(dev.webfx.kit.statusbar.spi.impl.none.NoneStatusBarProvide::new);
