...
public class ServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> ServiceLoader<S> load(Class<S> serviceClass) {
        switch (serviceClass.getName()) {
            ...
            case "dev.webfx.platform.shared.services.boot.spi.ApplicationModuleBooter": return new ServiceLoader<S>(dev.webfx.kit.launcher.WebFxKitLauncherModuleBooter::new, dev.webfx.platform.gwt.services.resource.spi.impl.GwtResourceModuleBooter::new, dev.webfx.platform.shared.services.boot.spi.impl.ApplicationJobsBooter::new, dev.webfx.stack.com.buscall.BusCallModuleBooter::new, dev.webfx.stack.com.serial.SerialCodecModuleBooter::new, dev.webfx.stack.framework.shared.interceptors.dqlquery.DqlQueryInterceptorModuleBooter::new, dev.webfx.stack.framework.shared.interceptors.dqlquerypush.DqlQueryPushInterceptorModuleBooter::new, dev.webfx.stack.framework.shared.interceptors.dqlsubmit.DqlSubmitInterceptorModuleBooter::new, org.modality_project.base.client.operationactionsloading.ModalityClientOperationActionsLoader::new);
            ...
            case "dev.webfx.stack.com.buscall.spi.BusCallEndpoint": return new ServiceLoader<S>(dev.webfx.stack.db.query.ExecuteQueryBatchBusCallEndpoint::new, dev.webfx.stack.db.query.ExecuteQueryBusCallEndpoint::new, dev.webfx.stack.db.submit.ExecuteSubmitBatchBusCallEndpoint::new, dev.webfx.stack.db.submit.ExecuteSubmitBusCallEndpoint::new, dev.webfx.stack.framework.shared.services.querypush.ExecuteQueryPushBusCallEndpoint::new);
            case "dev.webfx.stack.com.serial.spi.SerialCodec": return new ServiceLoader<S>(dev.webfx.stack.com.buscall.BusCallArgument.ProvidedSerialCodec::new, dev.webfx.stack.com.buscall.BusCallResult.ProvidedSerialCodec::new, dev.webfx.stack.com.buscall.SerializableAsyncResult.ProvidedSerialCodec::new, dev.webfx.stack.com.serial.spi.impl.ProvidedBatchSerialCodec::new, dev.webfx.stack.db.datascope.aggregate.AggregateScope.ProvidedSerialCodec::new, dev.webfx.stack.db.query.QueryArgument.ProvidedSerialCodec::new, dev.webfx.stack.db.query.QueryResult.ProvidedSerialCodec::new, dev.webfx.stack.db.submit.GeneratedKeyBatchIndex.ProvidedSerialCodec::new, dev.webfx.stack.db.submit.SubmitArgument.ProvidedSerialCodec::new, dev.webfx.stack.db.submit.SubmitResult.ProvidedSerialCodec::new, dev.webfx.stack.framework.shared.services.querypush.QueryPushArgument.ProvidedSerialCodec::new, dev.webfx.stack.framework.shared.services.querypush.QueryPushResult.ProvidedSerialCodec::new, dev.webfx.stack.framework.shared.services.querypush.diff.impl.QueryResultTranslation.ProvidedSerialCodec::new);
