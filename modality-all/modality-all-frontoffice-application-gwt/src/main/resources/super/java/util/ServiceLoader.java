...
public class ServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> ServiceLoader<S> load(Class<S> serviceClass) {
        switch (serviceClass.getName()) {
            ...
            case "dev.webfx.stack.conf.spi.ConfigurationSupplier": return new ServiceLoader<S>(dev.webfx.stack.conf.spi.impl.localstorage.LocalStorageConfigurationSupplier::new, dev.webfx.stack.conf.spi.impl.windowlocation.WindowLocationConfigurationSupplier::new, one.modality.base.client.busconfig.ModalityClientBusOptionsConfigurationSupplier::new);
