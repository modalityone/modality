...
package mongoose.all.frontoffice.application.gwt.embed;
...
public interface EmbedResourcesBundle extends ClientBundle {
    ...
    final class ProvidedGwtResourceBundle extends GwtResourceBundleBase {
        public ProvidedGwtResourceBundle() {
            ...
            registerResource("org/modality_project/base/client/services/i18n/dictionaries/en.json", R.r7());
            registerResource("org/modality_project/base/client/services/i18n/dictionaries/fr.json", R.r8());
            registerResource("org/modality_project/base/client/services/i18n/dictionaries/fr.json", R.r9());
            registerResource("org/modality_project/base/shared/domainmodel/DomainModelSnapshot.json", R.r10());
            registerResource("org/modality_project/base/shared/domainmodel/DomainModelSnapshot.json", R.r11());
