...
public class ServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> ServiceLoader<S> load(Class<S> serviceClass) {
        switch (serviceClass.getName()) {
            ...
            case "dev.webfx.platform.boot.spi.ApplicationModuleBooter": return new ServiceLoader<S>(dev.webfx.kit.launcher.WebFxKitLauncherModuleBooter::new, dev.webfx.platform.boot.spi.impl.ApplicationJobsBooter::new, dev.webfx.platform.resource.spi.impl.gwt.GwtResourceModuleBooter::new, dev.webfx.stack.com.bus.call.BusCallModuleBooter::new, dev.webfx.stack.com.serial.SerialCodecModuleBooter::new, dev.webfx.stack.orm.dql.query.interceptor.DqlQueryInterceptorModuleBooter::new, dev.webfx.stack.orm.dql.querypush.interceptor.DqlQueryPushInterceptorModuleBooter::new, dev.webfx.stack.orm.dql.submit.interceptor.DqlSubmitInterceptorModuleBooter::new, org.modality_project.base.client.operationactionsloading.ModalityClientOperationActionsLoader::new);
            ...
            case "dev.webfx.stack.routing.uirouter.UiRoute": return new ServiceLoader<S>(org.modality_project.base.backoffice.activities.filters.FiltersUiRoute::new, org.modality_project.base.backoffice.activities.monitor.MonitorUiRoute::new, org.modality_project.base.backoffice.activities.operations.OperationsUiRoute::new, org.modality_project.catering.backoffice.activities.diningareas.DiningAreasUiRoute::new, org.modality_project.crm.backoffice.activities.authorizations.AuthorizationsUiRoute::new, org.modality_project.crm.backoffice.activities.letter.LetterUiRoute::new, org.modality_project.crm.backoffice.activities.letters.LettersUiRoute::new, org.modality_project.crm.backoffice.activities.organizations.OrganizationsUiRoute::new, org.modality_project.crm.backoffice.activities.users.UsersUiRoute::new, org.modality_project.crm.client.activities.login.LoginUiRoute::new, org.modality_project.crm.client.activities.unauthorized.UnauthorizedUiRoute::new, org.modality_project.ecommerce.backoffice.activities.bookings.BookingsUiRoute::new, org.modality_project.ecommerce.backoffice.activities.income.IncomeUiRoute::new, org.modality_project.ecommerce.backoffice.activities.moneyflows.MoneyFlowsUiRoute::new, org.modality_project.ecommerce.backoffice.activities.payments.PaymentsUiRoute::new, org.modality_project.ecommerce.backoffice.activities.statements.StatementsUiRoute::new, org.modality_project.ecommerce.backoffice.activities.statistics.StatisticsUiRoute::new, org.modality_project.event.backoffice.activities.cloneevent.CloneEventUiRoute::new, org.modality_project.event.backoffice.activities.events.EventsUiRoute::new, org.modality_project.event.backoffice.activities.options.EditableOptionsUiRoute::new, org.modality_project.hotel.backoffice.activities.roomsgraphic.RoomsGraphicUiRoute::new);
            case "dev.webfx.stack.routing.uirouter.operations.RouteRequestEmitter": return new ServiceLoader<S>(org.modality_project.base.backoffice.activities.filters.RouteToFiltersRequestEmitter::new, org.modality_project.base.backoffice.activities.monitor.RouteToMonitorRequestEmitter::new, org.modality_project.base.backoffice.activities.operations.RouteToOperationsRequestEmitter::new, org.modality_project.catering.backoffice.activities.diningareas.RouteToDiningAreasRequestEmitter::new, org.modality_project.crm.backoffice.activities.authorizations.RouteToAuthorizationsRequestEmitter::new, org.modality_project.crm.backoffice.activities.letters.RouteToLettersRequestEmitter::new, org.modality_project.crm.backoffice.activities.organizations.RouteToOrganizationsRequestEmitter::new, org.modality_project.crm.backoffice.activities.users.RouteToUsersRequestEmitter::new, org.modality_project.ecommerce.backoffice.activities.bookings.RouteToBookingsRequestEmitter::new, org.modality_project.ecommerce.backoffice.activities.income.RouteToIncomeRequestEmitter::new, org.modality_project.ecommerce.backoffice.activities.moneyflows.RouteToMoneyFlowsRequestEmitter::new, org.modality_project.ecommerce.backoffice.activities.payments.RouteToPaymentsRequestEmitter::new, org.modality_project.ecommerce.backoffice.activities.statements.RouteToStatementsRequestEmitter::new, org.modality_project.ecommerce.backoffice.activities.statistics.RouteToStatisticsRequestEmitter::new, org.modality_project.event.backoffice.activities.events.RouteToEventsRequestEmitter::new, org.modality_project.hotel.backoffice.activities.roomsgraphic.RouteToRoomsGraphicRequestEmitter::new);
            case "javafx.application.Application": return new ServiceLoader<S>(org.modality_project.all.backoffice.application.ModalityBackOfficeApplication::new);
