...
public class ServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> ServiceLoader<S> load(Class<S> serviceClass) {
        switch (serviceClass.getName()) {
            ...
            case "dev.webfx.stack.com.bus.call.spi.BusCallEndpoint": return new ServiceLoader<S>(dev.webfx.stack.db.query.ExecuteQueryBatchBusCallEndpoint::new, dev.webfx.stack.db.query.ExecuteQueryBusCallEndpoint::new, dev.webfx.stack.db.submit.ExecuteSubmitBatchBusCallEndpoint::new, dev.webfx.stack.db.submit.ExecuteSubmitBusCallEndpoint::new, dev.webfx.stack.querypush.ExecuteQueryPushBusCallEndpoint::new);
