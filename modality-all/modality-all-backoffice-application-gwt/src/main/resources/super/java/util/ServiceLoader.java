...
public class ServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> ServiceLoader<S> load(Class<S> serviceClass) {
        switch (serviceClass.getName()) {
            ...
            case "dev.webfx.stack.com.serial.spi.SerialCodec": return new ServiceLoader<S>(dev.webfx.stack.com.bus.call.BusCallArgument.ProvidedSerialCodec::new, dev.webfx.stack.com.bus.call.BusCallResult.ProvidedSerialCodec::new, dev.webfx.stack.com.bus.call.SerializableAsyncResult.ProvidedSerialCodec::new, dev.webfx.stack.com.serial.spi.impl.ProvidedBatchSerialCodec::new, dev.webfx.stack.db.datascope.aggregate.AggregateScope.ProvidedSerialCodec::new, dev.webfx.stack.db.query.QueryArgument.ProvidedSerialCodec::new, dev.webfx.stack.db.query.QueryResult.ProvidedSerialCodec::new, dev.webfx.stack.db.submit.GeneratedKeyBatchIndex.ProvidedSerialCodec::new, dev.webfx.stack.db.submit.SubmitArgument.ProvidedSerialCodec::new, dev.webfx.stack.db.submit.SubmitResult.ProvidedSerialCodec::new, dev.webfx.stack.querypush.QueryPushArgument.ProvidedSerialCodec::new, dev.webfx.stack.querypush.QueryPushResult.ProvidedSerialCodec::new, dev.webfx.stack.querypush.diff.impl.QueryResultTranslation.ProvidedSerialCodec::new);
