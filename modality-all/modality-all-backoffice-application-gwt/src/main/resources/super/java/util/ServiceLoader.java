...
public class ServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> ServiceLoader<S> load(Class<S> serviceClass) {
        switch (serviceClass.getName()) {
            ...
            case "one.modality.base.backoffice.activities.mainframe.MainFrameHeaderNodeProvider": return new ServiceLoader<S>(one.modality.crm.backoffice.organization.fx.impl.MainFrameHeaderOrganizationSelectorProvider::new, one.modality.event.backoffice.event.fx.impl.MainFrameHeaderEventSelectorProvider::new);
