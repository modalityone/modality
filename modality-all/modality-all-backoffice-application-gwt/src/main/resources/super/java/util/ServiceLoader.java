...
public class ServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> ServiceLoader<S> load(Class<S> serviceClass) {
        switch (serviceClass.getName()) {
            ...
            case "dev.webfx.platform.boot.spi.ApplicationJob": return new ServiceLoader<S>(dev.webfx.stack.db.querypush.client.simple.SimpleQueryPushClientJob::new);
            ...
            case "dev.webfx.stack.auth.authn.spi.AuthenticationServiceProvider": return new ServiceLoader<S>(dev.webfx.stack.auth.authn.spi.impl.remote.RemoteAuthenticationServiceProvider::new);
            case "dev.webfx.stack.auth.authz.spi.AuthorizationServiceProvider": return new ServiceLoader<S>(one.modality.crm.client.services.authz.ModalityAuthorizationServiceProvider::new);
            case "dev.webfx.stack.com.bus.call.spi.BusCallEndpoint": return new ServiceLoader<S>(dev.webfx.stack.auth.authn.buscall.AuthenticateMethodEndpoint::new, dev.webfx.stack.db.query.buscall.ExecuteQueryBatchMethodEndpoint::new, dev.webfx.stack.db.query.buscall.ExecuteQueryMethodEndpoint::new, dev.webfx.stack.db.querypush.buscall.ExecuteQueryPushMethodEndpoint::new, dev.webfx.stack.db.submit.buscall.ExecuteSubmitBatchMethodEndpoint::new, dev.webfx.stack.db.submit.buscall.ExecuteSubmitMethodEndpoint::new);
