...
public class ServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> ServiceLoader<S> load(Class<S> serviceClass) {
        switch (serviceClass.getName()) {
            ...
            case "dev.webfx.stack.routing.uirouter.UiRoute": return new ServiceLoader<S>(one.modality.base.backoffice.activities.filters.FiltersUiRoute::new, one.modality.base.backoffice.activities.operations.OperationsUiRoute::new, one.modality.catering.backoffice.activities.home.HomeUiRoute::new, one.modality.catering.backoffice.activities.kitchen.KitchenUiRoute::new, one.modality.crm.client.activities.login.LoginUiRoute::new, one.modality.crm.client.activities.unauthorized.UnauthorizedUiRoute::new, one.modality.ecommerce.backoffice.activities.bookings.BookingsUiRoute::new, one.modality.ecommerce.backoffice.activities.moneyflows.MoneyFlowsUiRoute::new, one.modality.ecommerce.backoffice.activities.statistics.StatisticsUiRoute::new, one.modality.hotel.backoffice.activities.accommodation.AccommodationUiRoute::new, one.modality.hotel.backoffice.activities.household.HouseholdUiRoute::new);
            case "dev.webfx.stack.routing.uirouter.operations.RouteRequestEmitter": return new ServiceLoader<S>(one.modality.base.backoffice.activities.filters.RouteToFiltersRequestEmitter::new, one.modality.base.backoffice.activities.operations.RouteToOperationsRequestEmitter::new, one.modality.catering.backoffice.activities.home.RouteToHomeRequestEmitter::new, one.modality.catering.backoffice.activities.kitchen.RouteToKitchenRequestEmitter::new, one.modality.ecommerce.backoffice.activities.bookings.RouteToBookingsRequestEmitter::new, one.modality.ecommerce.backoffice.activities.moneyflows.RouteToMoneyFlowsRequestEmitter::new, one.modality.ecommerce.backoffice.activities.statistics.RouteToStatisticsRequestEmitter::new, one.modality.hotel.backoffice.activities.accommodation.RouteToAccommodationRequestEmitter::new, one.modality.hotel.backoffice.activities.household.RouteToHouseholdRequestEmitter::new);
            ...
            case "one.modality.base.backoffice.activities.mainframe.headernode.MainFrameHeaderNodeProvider": return new ServiceLoader<S>(one.modality.crm.backoffice.organization.fx.impl.MainFrameHeaderOrganizationSelectorProvider::new, one.modality.event.backoffice.event.fx.impl.MainFrameHeaderEventSelectorProvider::new);
